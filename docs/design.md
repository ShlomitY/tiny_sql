...
I decided to leave this approach and delete all of the code that was written and started the git repository
again from scratch.

From that link i reached a couple of conclusions about the staructure of how I want to implement storing the data.
1. I will a matrix for each of the tables that will be created.
2. Each of the tables will be linked to their names using a map.

////// continue writing the explanation about the stracture.
